...
public final class GLossaryisCreatedProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3e3749e596c04132L, 0x8c4a7309a74f9fd6L, 0x5567236ee43f4b2fL, "org.iets3.flow.modelproperty.gxw.structure.GLossaryisCreatedProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    GlossaryisCreatedPropertyClass checker = new GlossaryisCreatedPropertyClass();
  ...
  /*package*/ GLossaryisCreatedProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
