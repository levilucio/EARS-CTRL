...
public final class RequirementRealizable__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3e3749e596c04132L, 0x8c4a7309a74f9fd6L, 0x4cb0e8cd55e29317L, "org.iets3.flow.modelproperty.gxw.structure.RequirementRealizable");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    RequirementRealizableClass checker = new RequirementRealizableClass();
  ...
  /*package*/ RequirementRealizable__BehaviorDescriptor() {
    super(REGISTRY);
  }
