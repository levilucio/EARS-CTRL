...
public final class RequirementChunkPresentProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3e3749e596c04132L, 0x8c4a7309a74f9fd6L, 0x5567236ee467f31fL, "org.iets3.flow.modelproperty.gxw.structure.RequirementChunkPresentProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    ...
    RequirementChunkPresentClass checker = new RequirementChunkPresentClass();
  ...
  /*package*/ RequirementChunkPresentProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
