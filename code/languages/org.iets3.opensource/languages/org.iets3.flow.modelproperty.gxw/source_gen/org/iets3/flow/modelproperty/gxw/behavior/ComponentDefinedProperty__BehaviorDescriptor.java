...
public final class ComponentDefinedProperty__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3e3749e596c04132L, 0x8c4a7309a74f9fd6L, 0x5567236ee4693f1cL, "org.iets3.flow.modelproperty.gxw.structure.ComponentDefinedProperty");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    ComponentDefinedClass checker = new ComponentDefinedClass();
  ...
  /*package*/ ComponentDefinedProperty__BehaviorDescriptor() {
    super(REGISTRY);
  }
