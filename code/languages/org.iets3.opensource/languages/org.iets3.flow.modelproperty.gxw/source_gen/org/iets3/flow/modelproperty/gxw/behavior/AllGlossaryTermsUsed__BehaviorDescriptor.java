...
public final class AllGlossaryTermsUsed__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3e3749e596c04132L, 0x8c4a7309a74f9fd6L, 0x6477a78990a6aedL, "org.iets3.flow.modelproperty.gxw.structure.AllGlossaryTermsUsed");
  ...
  /*package*/ static boolean propertyCheck_id5fb3TbDEkMb(@NotNull SNode __thisNode__, SModel model) {
    AllGlossaryTermsUsedClass checker = new AllGlossaryTermsUsedClass();
  ...
  /*package*/ AllGlossaryTermsUsed__BehaviorDescriptor() {
    super(REGISTRY);
  }
