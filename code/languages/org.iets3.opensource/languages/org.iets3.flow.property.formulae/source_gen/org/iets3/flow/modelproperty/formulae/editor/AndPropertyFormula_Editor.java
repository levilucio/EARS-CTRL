...
public class AndPropertyFormula_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_pghn3d_a(editorContext, node);
  }
  private EditorCell createCollection_pghn3d_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_pghn3d_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createConstant_pghn3d_a0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_pghn3d_b0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_pghn3d_c0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_pghn3d_d0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_pghn3d_e0(editorContext, node));
    return editorCell;
  }
  private EditorCell createConstant_pghn3d_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "(");
    editorCell.setCellId("Constant_pghn3d_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_pghn3d_b0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new AndPropertyFormula_Editor.arg1SingleRoleHandler_pghn3d_b0(node, MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x2745279545540786L, "arg1"), editorContext);
    return provider.createCell();
  }
  private class arg1SingleRoleHandler_pghn3d_b0 extends SingleRoleCellProvider {
    public arg1SingleRoleHandler_pghn3d_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_pghn3d_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "AND");
    editorCell.setCellId("Constant_pghn3d_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_pghn3d_d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new AndPropertyFormula_Editor.arg2SingleRoleHandler_pghn3d_d0(node, MetaAdapterFactory.getContainmentLink(0xc020a239d8654312L, 0xadc3cb4ab0a7a547L, 0x3d9c6ca8374334d5L, 0x274527954554078cL, "arg2"), editorContext);
    return provider.createCell();
  }
  private class arg2SingleRoleHandler_pghn3d_d0 extends SingleRoleCellProvider {
    public arg2SingleRoleHandler_pghn3d_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
  ...
  private EditorCell createConstant_pghn3d_e0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ")");
    editorCell.setCellId("Constant_pghn3d_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
}
