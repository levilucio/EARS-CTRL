...
public class ComplexEventDrivenReq_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ophw3y_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createModelAccess_ophw3y_h0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createConstant_ophw3y_k0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_ophw3y_f0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new ComplexEventDrivenReq_Editor.triggerSingleRoleHandler_ophw3y_f0(node, MetaAdapterFactory.getContainmentLink(0x7731a166da1f472eL, 0xa40a2283f5e47dc5L, 0x6979ba361f3d77d6L, 0x7985bc66bb09e3a8L, "trigger"), editorContext);
    return provider.createCell();
  }
  private class triggerSingleRoleHandler_ophw3y_f0 extends SingleRoleCellProvider {
    public triggerSingleRoleHandler_ophw3y_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
  ...
  private EditorCell createModelAccess_ophw3y_h0(final EditorContext editorContext, final SNode node) {
    ...
    editorCell.setCellId("ModelAccess_ophw3y_h0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createRefNode_ophw3y_j0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new ComplexEventDrivenReq_Editor.responseSingleRoleHandler_ophw3y_j0(node, MetaAdapterFactory.getContainmentLink(0x7731a166da1f472eL, 0xa40a2283f5e47dc5L, 0x6979ba361f3d77d6L, 0x7985bc66bb09e3a9L, "response"), editorContext);
    return provider.createCell();
  }
  private class responseSingleRoleHandler_ophw3y_j0 extends SingleRoleCellProvider {
    public responseSingleRoleHandler_ophw3y_j0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
  ...
  private EditorCell createConstant_ophw3y_k0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ".");
    editorCell.setCellId("Constant_ophw3y_k0");
    editorCell.setDefaultText("");
    return editorCell;
  }
