...
public class State_DirectedGraph_Editor extends DefaultNodeEditor {
  private Collection<String> myContextHints = Arrays.asList(new String[]{"org.iets3.flow.dashboard.editor.DashboardVisualisation.DirectedGraph"});
  @Override
  @NotNull
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createDiagramNode_2oot6_a(editorContext, node);
  }
  private EditorCell createDiagramNode_2oot6_a(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        EditorCell contentCell = createCollection_2oot6_a0(editorContext, node);
        ...
        editorCell.value.setCellId("DiagramNode_2oot6_a");
        editorCell.value.setBig(true);
        Style style = new StyleImpl();
        if (State_DirectedGraph_Editor._StyleParameter_QueryFunction_2oot6_a0a(editorContext, node)) {
          {
        ...
        if (State_DirectedGraph_Editor._StyleParameter_QueryFunction_2oot6_a1a(editorContext, node)) {
          {
            Style styleToPut = new StyleImpl();
        ...
        if (State_DirectedGraph_Editor._StyleParameter_QueryFunction_2oot6_a2a(editorContext, node)) {
          {
            Style styleToPut = new StyleImpl();
        ...
        if (State_DirectedGraph_Editor._StyleParameter_QueryFunction_2oot6_a3a(editorContext, node)) {
          {
            Style styleToPut = new StyleImpl();
  ...
  private static boolean _StyleParameter_QueryFunction_2oot6_a0a(EditorContext editorContext, SNode node) {
  ...
  private static boolean _StyleParameter_QueryFunction_2oot6_a1a(EditorContext editorContext, SNode node) {
  ...
  private static boolean _StyleParameter_QueryFunction_2oot6_a2a(EditorContext editorContext, SNode node) {
  ...
  private static boolean _StyleParameter_QueryFunction_2oot6_a3a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createCollection_2oot6_a0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createVertical(editorContext, node);
    editorCell.setCellId("Collection_2oot6_a0");
    editorCell.addEditorCell(this.createProperty_2oot6_a0a(editorContext, node));
    editorCell.addEditorCell(this.createCollection_2oot6_b0a(editorContext, node));
    return editorCell;
  }
  private EditorCell createProperty_2oot6_a0a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createCollection_2oot6_b0a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_2oot6_b0a");
    editorCell.addEditorCell(this.createConstant_2oot6_a1a0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_2oot6_b1a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createConstant_2oot6_a1a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Status:");
    editorCell.setCellId("Constant_2oot6_a1a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_2oot6_b1a0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
